...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['disabled', 'editable', 'field', 'moveable', 'recipient'],
  methods: ['focusField']
})
@Component({
...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['disabled', 'editable', 'field', 'initials', 'moveable', 'recipient'],
  methods: ['focusField']
})
@Component({
...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['disabled', 'editable', 'field', 'moveable', 'name', 'recipient'],
  methods: ['focusField']
})
@Component({
