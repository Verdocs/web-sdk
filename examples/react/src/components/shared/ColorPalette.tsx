...
export const ColorPalette = ({themeRevision = 0}: ColorPaletteProps) => {
  ...
  return (
    <section className="color-palette" aria-label="Theme color palette">
      <h3 className="color-palette-title">Color palette</h3>
      <p className="color-palette-hint">
        Defined in <code>src/styles/example-theme.css</code> as <code>--example-*</code> tokens. Toggle white-label
        theme to map them onto Verdocs embeds.
      </p>
