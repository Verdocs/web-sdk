...
import { IDocumentPageInfo, IPageLayer, TDownloadAction } from "./utils/Types";
...
export { IDocumentPageInfo, IPageLayer, TDownloadAction } from "./utils/Types";
...
declare global {
    ...
    interface HTMLVerdocsDownloadDialogElementEventMap {
        "download": {action: TDownloadAction; documentId?: string};
        "exit": any;
    }
...
declare namespace LocalJSX {
    ...
    interface VerdocsDownloadDialog {
         ...
         */
        "onDownload"?: (event: VerdocsDownloadDialogCustomEvent<{action: TDownloadAction; documentId?: string}>) => void;
        /**
