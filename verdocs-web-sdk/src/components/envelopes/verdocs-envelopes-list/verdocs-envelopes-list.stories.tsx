...
export default {
  title: 'Envelopes/Evnelopes List',
...
export const EnvelopesList = ({theme, size, status, envelope}) =>
  html`<verdocs-envelopes-list .theme="${theme}" .size="${size}" .status="${status}" .envelope="${envelope}" />`;
