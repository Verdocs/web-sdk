...
export class VerdocsBuild {
  ...
  async componentDidLoad() {
    try {
      ...
      console.log('[BUILD] Got template', this.template);
      ...
      console.log('[BUILD] Loaded roles', this.roles);
  ...
  renderField(field: ITemplateField, docPage: IDocumentPageInfo /*, index: number*/) {
    ...
    switch (field.type) {
      ...
      //   break;
      default:
        console.log('[BUILD] Skipping unsupported field type', field);
    }
  ...
  handlePageRendered(e) {
    ...
    console.log('[BUILD] Page rendered', pageInfo);

    const fields = this.fields.filter(field => field.page_sequence === pageInfo.renderedPage.pageNumber);
    console.log('[BUILD] Fields on page', fields);
