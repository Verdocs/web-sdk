...
import {getCombinedEnvelopeDocumentDownloadLink, getEnvelopeDocumentDownloadLink} from '@verdocs/js-sdk';
import {cancelEnvelope, getEnvelope, IEnvelope, integerSequence, VerdocsEndpoint, getEnvelopesZip, getMyRecipient} from '@verdocs/js-sdk';
      ...
      <Host>
        ...
        {this.showDownloadDialog && (
          <verdocs-download-dialog
            ...
            onDownload={e => this.handleDownloadDocuments(e)}
          />
        )}
