    ...
    return (
      <verdocs-dialog>
        <div slot="heading" class="heading">
          ...
          <div class="title">Delegate Signing</div>
        </div>

        <div slot="content" class="content">
          <div class="verdocs-form">
            <div class="verdocs-form-row">
              <div class="field-group">
                <label htmlFor="verdocs-delegate-first" class="verdocs-form-label">
                  New Recipient*
                </label>
                <input
                  type="text"
              ...
              <div class="field-group">
                <label htmlFor="verdocs-delegate-last" class="verdocs-form-label">
                  &nbsp;
                </label>
                <input
                  type="text"
            ...
            <div>
              <label htmlFor="verdocs-delegate-email" class="verdocs-form-label">
                Email Address*
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="verdocs-delegate-message" class="verdocs-form-label">
                Message (optional)
              </label>
              <textarea
