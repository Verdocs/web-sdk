...
export class VerdocsDownloadDialog {
   ...
   * Event fired when an option is selected.
   */
  @Event({composed: true}) download: EventEmitter<{action: TDownloadAction; documentId?: string}>;
      ...
      <verdocs-dialog onExit={() => this.exit.emit()}>
        ...
        <div slot="content" class="content">
          {attachments.length <= 2 &&
            attachments.map(doc => (
              <div class="download-option" onClick={() => this.handleOptionClick(TDownloadAction.document, doc.id)}>
          ...
          <div
            ...
            onClick={() => this.handleOptionClick(TDownloadAction.certificate)}
          ...
          <div
            ...
            onClick={() => this.handleOptionClick(TDownloadAction.zip)}
