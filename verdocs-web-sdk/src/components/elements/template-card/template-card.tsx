    ...
    return (
      <div class="container">
        ...
        <div class="template-controls">
          <span class="star-counter" innerHTML={StarIcon} >{this.template.star_counter}</span>
          <span class="pages" innerHTML={PagesIcon} >{this.template.pages}</span>
          <span class="counter" innerHTML={EmailIcon} >{this.template.counter}</span>
