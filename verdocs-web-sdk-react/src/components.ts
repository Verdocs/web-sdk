...
type VerdocsFieldPaymentEvents = {
    ...
    onSettingsChanged: EventName<VerdocsFieldPaymentCustomEvent<{ fieldName: string; settings: ITemplateFieldSetting; field: ITemplateField }>>,
    onDeleted: EventName<CustomEvent<{ fieldName: string }>>
};
...
type VerdocsTemplateNameEvents = {
    ...
    onTemplateUpdated: EventName<VerdocsTemplateNameCustomEvent<{ endpoint: VerdocsEndpoint; template: ITemplate; event: string }>>
};

export const VerdocsTemplateName: StencilReactComponent<VerdocsTemplateNameElement, VerdocsTemplateNameEvents> = /*@__PURE__*/ createComponent<VerdocsTemplateNameElement, VerdocsTemplateNameEvents>({
...
type VerdocsTemplateVisibilityEvents = {
    ...
    onTemplateUpdated: EventName<VerdocsTemplateVisibilityCustomEvent<{ endpoint: VerdocsEndpoint; template: ITemplate; event: string }>>
};

export const VerdocsTemplateVisibility: StencilReactComponent<VerdocsTemplateVisibilityElement, VerdocsTemplateVisibilityEvents> = /*@__PURE__*/ createComponent<VerdocsTemplateVisibilityElement, VerdocsTemplateVisibilityEvents>({
    ...
    events: {
        ...
        onSdkError: 'sdkError',
        onTemplateUpdated: 'templateUpdated'
    } as VerdocsTemplateVisibilityEvents,
...
type VerdocsTextInputEvents = { onBlur: EventName<CustomEvent<any>> };
...
export const VerdocsTextInput: StencilReactComponent<VerdocsTextInputElement, VerdocsTextInputEvents> = /*@__PURE__*/ createComponent<VerdocsTextInputElement, VerdocsTextInputEvents>({
    ...
    // @ts-ignore - React type of Stencil Output Target may differ from the React version used in the Nuxt.js project, this can be ignored.
    react: React,
    events: { onBlur: 'blur' } as VerdocsTextInputEvents,
