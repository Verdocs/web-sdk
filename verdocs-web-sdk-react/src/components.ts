...
export type VerdocsSendEvents = {
    onBeforeSend: EventName<VerdocsSendCustomEvent<ISendEventDetail>>,
    onSend: EventName<VerdocsSendCustomEvent<ISentEventDetail>>,
